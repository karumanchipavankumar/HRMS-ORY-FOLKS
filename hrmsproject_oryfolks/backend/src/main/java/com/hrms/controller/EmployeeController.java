...
public class EmployeeController {
    ...
    public ResponseEntity<?> generateEmployeeId(
        ...
        switch (role.toUpperCase()) {
            case "HR":         rolePrefix = "OF-HR"; break;
            case "EMPLOYEE":   rolePrefix = "OF-IT"; break;
            default:
        ...
        for (com.hrms.model.CompanyDetail cd : existing) {
            if (cd.getOryfolksId() != null) {
                // Format: OF-IT-GS-0001 → last segment is seq number
        ...
        if (!emailPrefix.isEmpty()) {
            ...
            int count = 1;
            while (companyDetailRepository.findByOryfolksMailId(finalEmail + "@oryfolks.com").isPresent()) {

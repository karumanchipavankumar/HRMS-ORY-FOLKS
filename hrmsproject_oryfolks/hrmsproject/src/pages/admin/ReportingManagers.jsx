          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1">
            ...
            <div className="lg:col-span-1 flex flex-col space-y-4">
              <div className="flex items-center justify-between px-2">
                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-blue/40">Reporting Manager's List</h3>
              ...
              <div className="bg-white rounded-3xl shadow-xl shadow-brand-blue/5 border border-brand-blue/5 overflow-hidden flex-1 flex flex-col">
                <div className="overflow-y-auto p-4 space-y-2 flex-1 list-scrollbar max-h-[calc(100vh-220px)]">
                  {loading ? (

...
export default function EmployeeProfile() {
  ...
  const handleChange = (e) => {
    ...
    if (['firstName', 'middleName', 'lastName', 'emergencyContactName'].includes(name)) {
      ...
      const validation = validateJoiningDate(value);
      error = validation.error;
    }
  ...
  const handlePhotoUpload = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const currentUserId = storedUser?.employeeId || storedUser?.id;
              ...
              <div className="flex items-center gap-3">
                {(userRole === "ADMIN" || userRole === "HR") && !isReadOnly && (
                  <button
                    ...
                    className={`px-4 py-2 ${editing ? 'bg-green-500' : 'bg-brand-blue'} text-white font-semibold rounded-lg shadow-sm hover:opacity-90 transition-all flex items-center gap-2 whitespace-nowrap`}
                  >
                    {loading && editing ? (
            ...
            <aside className="lg:col-span-1">
              <div className="bg-[#F8F7F4] rounded-2xl border border-black/5 p-5 lg:sticky lg:top-4">
                <div className="flex flex-col items-center text-center pb-5 border-b border-black/5">
                  ...
                  <p className="text-[13px] text-brand-blue/50 mt-0.5">{form.role || employee?.designation || "Designation"}</p>
                ...
                <div className={`p-8 ${editing ? 'profile-editing' : ''}`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <div>
                              <input 
                                ...
                                disabled={!editing} 
                                maxLength="32"
                                className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all placeholder:text-brand-blue/20 ${fieldErrors.firstName && touched.firstName ? 'ring-2 ring-red-500 bg-red-50' : ''}`} 
                            ...
                            <div>
                              <input 
                                ...
                                disabled={!editing} 
                                maxLength="32"
                                className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all placeholder:text-brand-blue/20 ${fieldErrors.middleName && touched.middleName ? 'ring-2 ring-red-500 bg-red-50' : ''}`} 
                            ...
                            <div>
                              <input 
                                ...
                                disabled={!editing} 
                                maxLength="32"
                                className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all placeholder:text-brand-blue/20 ${fieldErrors.lastName && touched.lastName ? 'ring-2 ring-red-500 bg-red-50' : ''}`} 
                                ...
                                <div>
                                  <div className="flex gap-1">
                                    <select
                                      ...
                                      onChange={handleChange}
                                      disabled={isDisabled}
                                      className={`w-28 bg-[#F8F7F4] border-none rounded-xl px-2 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${isDisabled ? 'opacity-60 cursor-not-allowed' : ''}`}
                                    >
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea 
                            ...
                            rows="2"
                            maxLength="252"
                            className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${fieldErrors.currentAddress && touched.currentAddress ? 'ring-2 ring-red-500 bg-red-50' : ''} ${(!editing || userRole === 'ADMIN') ? 'opacity-60 cursor-not-allowed' : ''}`} 
                          />
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea 
                            ...
                            rows="2"
                            maxLength="252"
                            className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${fieldErrors.permanentAddress && touched.permanentAddress ? 'ring-2 ring-red-500 bg-red-50' : ''} ${(!editing || userRole === 'ADMIN') ? 'opacity-60 cursor-not-allowed' : ''}`} 
                          />
                  ...
                  {activeSection === 'emergency' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          {field.name === 'emergencyPhone' ? (
                            <div>
                              <div className="flex gap-1">
                                <select
                                  ...
                                  onChange={handleChange}
                                  disabled={!editing}
                                  className={`w-28 bg-[#F8F7F4] border-none rounded-xl px-2 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${(!editing) ? 'opacity-60 cursor-not-allowed' : ''}`}
                                >
                                  <option value="+91">+91 (IN)</option>
                                  <option value="+81">+81 (JP)</option>
                                </select>
                                <input
                                  ...
                                  inputMode="numeric"
                                  maxLength={getMobileMaxDigits(form[`${field.name}CountryCode`] || '+91')}
                                  className={`flex-1 bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${fieldErrors[field.name] && touched[field.name] ? 'ring-2 ring-red-500 bg-red-50' : ''} ${(!editing) ? 'opacity-60 cursor-not-allowed' : ''}`}
                                />
                              </div>
                              {fieldErrors[field.name] && touched[field.name] && <FormFieldError error={fieldErrors[field.name]} show={true} />}
                            </div>
                            ...
                            <div>
                              <select
                                ...
                                onBlur={handleBlur}
                                disabled={!editing}
                                className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${fieldErrors[field.name] && touched[field.name] ? 'ring-2 ring-red-500 bg-red-50' : ''} ${(!editing) ? 'opacity-60 cursor-not-allowed' : ''}`}
                              >
                      ...
                      <div className="md:col-span-2 space-y-2">
                        <label className="text-[11px] font-bold text-brand-blue/50 uppercase tracking-[0.06em] ml-1">Address</label>
                        <textarea 
                          ...
                          rows="3"
                          maxLength="252"
                          className={`w-full bg-[#F8F7F4] border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-blue focus:ring-2 focus:ring-brand-yellow/50 transition-all ${fieldErrors.emergencyAddress && touched.emergencyAddress ? 'ring-2 ring-red-500 bg-red-50' : ''} ${(!editing) ? 'opacity-60 cursor-not-allowed' : ''}`} 
                        />

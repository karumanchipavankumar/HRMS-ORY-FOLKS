  ...
  return (
    <div className="flex min-h-screen bg-bg-slate font-brand text-brand-blue">
      ...
      <main className="flex-1 flex flex-col">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-2xl font-black text-brand-blue tracking-tight">
                  Hi, {(user.firstName) ? user.firstName : "Manager"}!
                </h1>
                <p className="text-[10px] text-brand-blue/40 uppercase font-black tracking-[0.2em] mt-0.5">
                  Reporting Manager | {user.designation || "Reporting Manager"}
                </p>
              </div>
            </div>
          ...
          <header className="bg-white px-8 py-4 flex items-center justify-between shadow-sm z-30 border-b border-brand-blue/5">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-brand-blue/40 uppercase font-black tracking-[0.2em] mt-0.5">
                  {activeTab === 'team' ? 'Team Leadership Hub' : activeTab === 'profile' ? 'Profile Management' : activeTab === 'timesheet' ? 'My Timesheet' : 'Leave Administration'}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3 relative" id="profile-dropdown-container">
        ...
        {/* Content Area */}
        <div className={`flex-1 ${activeTab === 'profile' ? 'p-2 md:p-6' : activeTab === 'timesheet' ? 'p-4 md:px-10 md:py-4' : 'p-4 md:p-10'} flex flex-col ${activeTab === 'profile' ? 'gap-2' : activeTab === 'timesheet' ? 'space-y-4' : 'space-y-8'}`}>
          {activeTab === 'dashboard' && (
            viewTimesheetWeek ? (

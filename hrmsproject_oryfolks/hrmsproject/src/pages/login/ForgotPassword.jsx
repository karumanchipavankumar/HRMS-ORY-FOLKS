...
const ForgotPassword = () => {
  ...
  const labelClass = "text-sm font-semibold text-brand-blue/80";
  const primaryBtn =
    "w-full py-3 bg-brand-blue text-white rounded-lg font-bold hover:bg-brand-blue-hover active:scale-[0.98] transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 group";
  const ArrowIcon = () => (
    ...
    >
      ...
      <div className="w-full max-w-[460px] p-10 bg-white/70 backdrop-blur-xl rounded-[32px] shadow-2xl relative z-10 border border-white/40 ring-1 ring-black/5 mx-4">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-brand-blue">Forgot Password</h2>
        ...
        <div className="space-y-6">
          ...
          {step === 2 && (
            <>
              ...
              <p
                className="text-center text-sm text-brand-blue/60 hover:text-brand-yellow cursor-pointer transition-colors font-medium"
                onClick={() => setStep(1)}
              >
                Resend OTP?
              </p>

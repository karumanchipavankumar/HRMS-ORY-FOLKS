			...
			<div className="flex-1 flex flex-col overflow-hidden">
				...
				<div className="flex-1 p-4 md:p-8 h-full overflow-hidden flex flex-col gap-4">
					...
					<div className="flex flex-col gap-4 h-full overflow-hidden">
						...
						{/* METRIC CARDS - Total / Present / Absent today */}
								...
								<div className="w-full flex-1 flex flex-col items-center gap-3 min-h-0">
											...
											<PieChart>
												<Pie
													data={(() => {
														...
														return [
															{ name: 'HR\'s', value: isFutureMonth ? 0 : stats.hrUsers, color: '#1E3A8A' },
															{ name: 'Reporting manager\'s', value: isFutureMonth ? 0 : stats.reportingManagers, color: '#FACC15' },
									...
									<div className="flex flex-row flex-wrap justify-center gap-2 w-full shrink-0">
										{(() => {
											...
											return [
												{ label: 'HR\'s', value: isFutureMonth ? 0 : stats.hrUsers, color: 'bg-[#1E3A8A]', textColor: 'text-[#1E3A8A]' },
												{ label: 'Reporting manager\'s', value: isFutureMonth ? 0 : stats.reportingManagers, color: 'bg-[#FACC15]', textColor: 'text-[#FACC15]' },

...
export default function CompanyDetailsModal({ open, onClose, onSave }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="bg-[#f8fafc] w-full max-w-5xl h-[90vh] md:h-[85vh] rounded-3xl md:rounded-[2rem] shadow-2xl relative z-10 overflow-hidden flex flex-col md:flex-row border border-brand-blue/5">

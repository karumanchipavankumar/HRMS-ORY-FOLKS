...
// ===== Configurable session timeout (change these to adjust durations) =====
 ...
 * - Resets a countdown on any user activity (mouse / keyboard / scroll / touch).
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center border border-slate-200">
        ...
        <h3 className="text-lg font-semibold text-brand-blue mb-1">Session about to expire</h3>
        <p className="text-sm text-slate-500">
          Your session will expire in <span className="font-semibold text-brand-blue tabular-nums">{timeStr}</span>.
        </p>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-2.5 rounded-md border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-100 transition-colors"
          >
            Log out
          </button>
          <button
            ...
            className="flex-1 py-2.5 rounded-md bg-brand-yellow text-brand-blue text-sm font-medium hover:opacity-90 transition-colors"
          >
            Continue session
          </button>
        </div>

...
function App() {
  ...
  React.useEffect(() => {
    // Sync if localStorage changes in other tabs or if user photo is updated in the current tab
    ...
    window.addEventListener('userPhotoUpdated', handleStorageChange);
    return () => {
      window.removeEventListener('storage', handleStorageChange);
      window.removeEventListener('userPhotoUpdated', handleStorageChange);
    };
  }, []);

...
// ============================================================================
// JOINING DATE VALIDATION (Within 2 years before or 3 months after the current date)
// ============================================================================
export const validateJoiningDate = (value) => {
  ...
  if (joinDate < minDate || joinDate > maxDate) {
    return {
      isValid: false,
      error: "Joining Date must be within 2 years before or 3 months after the current date"
    };
  }
